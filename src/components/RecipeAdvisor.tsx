...
import { Loader2, Sparkles, ChefHat, Clock, Apple, Beef, Wheat, Droplets, AlertTriangle } from "lucide-react";
...
export default function RecipeAdvisor({ remainingBudget }: RecipeAdvisorProps) {
