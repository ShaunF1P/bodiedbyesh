          ...
          <AnimateIn from="left" delay={100}>
            <div className="relative glass-panel-lime rounded-3xl p-8 lg:p-12 overflow-hidden flex flex-col justify-between hover:shadow-2xl hover:shadow-accent-lime/5 transition-all duration-300 h-full">
              ...
              <div className="flex flex-col sm:flex-row gap-4 items-stretch sm:items-center mt-auto">
                <Link
                  href="/park"
                  className="inline-flex items-center justify-center bg-accent-lime text-cyber-slate px-6 py-3 rounded-full text-xs font-bold uppercase tracking-wider hover:bg-accent-lime/90 transition-all text-center"
                >
                  Explore Park Programs
                </Link>
                <Link
                  href="/calculator"
                  className="inline-flex items-center justify-center border border-white/10 hover:border-accent-lime/40 text-ice-white px-6 py-3 rounded-full text-xs font-semibold uppercase tracking-wider hover:text-accent-lime transition-all text-center"
                >
                  Estimate Macro Split
                </Link>
              </div>
            </div>
          </AnimateIn>
          ...
          <AnimateIn from="right" delay={200}>
            <div className="relative glass-panel-violet rounded-3xl p-8 lg:p-12 overflow-hidden flex flex-col justify-between hover:shadow-2xl hover:shadow-accent-violet/5 transition-all duration-300 h-full">
              ...
              <div className="flex flex-col sm:flex-row gap-4 items-stretch sm:items-center mt-auto">
                <Link
                  href="/apply"
                  className="inline-flex items-center justify-center bg-accent-violet text-white px-6 py-3 rounded-full text-xs font-bold uppercase tracking-wider hover:bg-accent-violet/90 transition-all text-center shadow-lg shadow-accent-violet/15"
                >
                  Apply for Executive 1-on-1
                </Link>
                <Link
                  href="/dashboard"
                  className="inline-flex items-center justify-center border border-white/10 hover:border-accent-violet/40 text-ice-white px-6 py-3 rounded-full text-xs font-semibold uppercase tracking-wider hover:text-accent-violet transition-all text-center"
                >
                  View App Demo
                </Link>
              </div>
